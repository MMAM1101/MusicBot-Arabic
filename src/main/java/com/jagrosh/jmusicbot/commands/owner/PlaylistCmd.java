...
public class PlaylistCmd extends OwnerCommand 
{
    ...
    public PlaylistCmd(Bot bot)
    {
        ...
        this.name = "ادارة_قوائم";
        this.arguments = "<append|delete|make|setdefault>";
        this.help = "إدارة قوائم التشغيل";
    ...
    public class MakelistCmd extends OwnerCommand 
    {
        public MakelistCmd()
        {
            ...
            this.help = "ينشئ قائمة تشغيل جديدة";
        ...
        protected void execute(CommandEvent event) 
        {
            ...
            {
                event.replyError("يرجى إدخال اسم لقائمة التشغيل!");
            } 
    ...
    public class DeletelistCmd extends OwnerCommand 
    {
        public DeletelistCmd()
        {
            ...
            this.help = "يحذف قائمة تشغيل موجودة";
            this.arguments = "<الاسم>";
            this.guildOnly = false;
        }
    ...
    public class AppendlistCmd extends OwnerCommand 
    {
        public AppendlistCmd()
        {
            ...
            this.help = "يضيف أغاني إلى قائمة تشغيل موجودة";
    ...
    public class ListCmd extends OwnerCommand 
    {
        public ListCmd()
        {
            ...
            this.help = "يعرض جميع قوائم التشغيل المتوفرة";
            this.guildOnly = true;
        }
