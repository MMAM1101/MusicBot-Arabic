...
public class QueueCmd extends MusicCommand 
{
    ...
    public QueueCmd(Bot bot)
    {
        super(bot);
        this.name = "القائمة";
        this.help = "يعرض القائمة الحالية";
    ...
    public void doCommand(CommandEvent event)
    {
        ...
        if(list.isEmpty())
        {
            ...
            Message built = new MessageBuilder()
                    .setContent(event.getClient().getWarning() + " لا يوجد موسيقى في القائمة!")
    ...
    private String getQueueTitle(AudioHandler ah, String success, int songslength, long total, RepeatMode repeatmode, QueueType queueType)
    {
        ...
        return FormatUtil.filter(sb.append(success).append(" القائمة الحالية | ").append(songslength)
                .append(" مقطع | `").append(TimeUtil.formatTime(total)).append("` ")
