...
public class AudioHandler extends AudioEventAdapter implements AudioSendHandler 
{
    ...
    public Message getNowPlaying(JDA jda)
    {
        if(isMusicPlaying(jda))
        {
            ...
            mb.append(FormatUtil.filter(manager.getBot().getConfig().getSuccess()+" **يعمل الآن في "+guild.getSelfMember().getVoiceState().getChannel().getAsMention()+"...**"));
            ...
            if(track.getInfo().author != null && !track.getInfo().author.isEmpty())
                eb.setFooter("المصدر: " + track.getInfo().author, null);
    ...
    public Message getNoMusicPlaying(JDA jda)
    {
        ...
        return new MessageBuilder()
                .setContent(FormatUtil.filter(manager.getBot().getConfig().getSuccess()+" **يعمل الآن...**"))
                .setEmbeds(new EmbedBuilder()
                .setTitle("لا يوجد شيء قيد التشغيل")
